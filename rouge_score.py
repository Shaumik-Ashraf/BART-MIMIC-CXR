...
scorer = rouge.Rouge(metrics=['rouge-l'], max_n=4, limit_length=True, length_limit=100,
                     length_limit_type='words', apply_avg=True, apply_best=False,
                     alpha=0.5, weight_factor=1.0, stemming=True)
...
prec, recall, f1_score = scorer.get_scores([generatored], [truth]);
